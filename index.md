...
<section class="hero">
    ...
    <div class="hero-content">
        <h1>Connor Spears</h1>
        <p class="tagline">Systems Programmer and Tech Designer</p>
        <p class="subtext">Indie dev, teacher, and retro gamer.</p>
    </div>
</section>
...
<h2>Projects</h2>
    ...
    <a href="/projects/CorDraconis/CorDraconis.html" class="project-link-wrapper">
        ...
        <p>
            Created a prototype for a fantasy city builder with RPG elements. Pitched that prototype into semester long production cycle where I served as creative director. My tasks included design documentation, project management, as well as some systems programming.
        </p>
    ...
    <!--<div class="project-card">
        <a href="/projects/ProjectPlaylist/ProjectPlaylist.html" class="project-link-wrapper">
            ...
            <p>
                Developed a neural network in Python using TensorFlow and Pandas to classify songs by genre based on audio features. Leveraged the MusicBrainz and AcousticBrainz APIs for data collection and training. The app allows the user to enter a song and artist name and returns the predicted genre based on its values.
            </p>
            <span class="project-link">View Project →</span>
        </a>
    </div>-->
